...
class GetWeeklyAverageProgressTest {
    ...
    fun `1 drink every day with intake 50 will return 50 average progress`(){
        val allDrinks = mutableListOf<com.akshaw.drinkreminder.waterdomain.model.Drink>().apply {
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now(), 50.0, WaterUnit.ML))
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now().minusDays(1), 50.0, WaterUnit.ML))
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now().minusDays(2), 50.0, WaterUnit.ML))
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now().minusDays(3), 50.0, WaterUnit.ML))
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now().minusDays(4), 50.0, WaterUnit.ML))
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now().minusDays(5), 50.0, WaterUnit.ML))
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now().minusDays(6), 50.0, WaterUnit.ML))
        }
        val progress = getWeeklyAverageProgress(allDrinks)
    ...
    fun `1 drink on first and other out of week with intake 50 will return 50 by 7 average progress`(){
        val allDrinks = mutableListOf<com.akshaw.drinkreminder.waterdomain.model.Drink>().apply {
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now(), 50.0, WaterUnit.ML))
            add(com.akshaw.drinkreminder.waterdomain.model.Drink(0, LocalDateTime.now().plusDays(24), 50.0, WaterUnit.ML))
        }
        val progress = getWeeklyAverageProgress(allDrinks)
